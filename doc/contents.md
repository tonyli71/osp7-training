...
我们提供 OSP 主任统一的 CLI 也是 **上游** 组件，**插件** 到上游 **OpenStackClient** (http://docs.openstack.org/developer/python-openstackclient) [工具集]  
。它添加在 undercloud 和 overcloud 的扩展来允许我们对接口主任工具和实用程序与本机 OpenStack API 正在使用。
